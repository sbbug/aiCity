...
#
#         th = GrapLeftCamerasThread(self, cameras=self.cameras, logger=self.logger)
#         th.start()
#
#     def startDetectGrapCamerasThread(self):
#
#         th = GrapDetectCamerasThread(self, cameras=self.cameras, logger=self.logger)
#         th.start()
#
#     def startDetectCameraThread(self):
#
#         th = DetectThread(self, self.cameras)
