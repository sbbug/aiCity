...
class TitleBar(QWidget):
    ...
    def InitializeViews(self):
        ...
        self.minButton.setIcon(QIcon(getProjectContext()+"UI/resources/images/min.png"));
        self.restoreButton.setIcon(QIcon(getProjectContext()+"UI/resources/images/restore.png"));
        self.closeButton.setIcon(QIcon(getProjectContext()+"UI/resources/images/exit.png"));
